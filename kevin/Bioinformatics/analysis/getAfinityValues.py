...
# mfeDictionary which is serialized     #
# under mfeDict.pickle. It is accesable #
# via import. The rest of the           #
# functions here can be used to read    #
# in other mfe outfiles.                #
#########################################
...
# only needed when mfe files are in the directory
# example: mfeDict = generateDict("./nupackmfe")
